...
**Spec Reference:** Sec 3.7 (Abstract Commands), Sec 3.14.6 (`abstractcs`), Sec 3.14.7 (`command`), Sec 3.14.14 (`data0`)
...
**Practical use:** You can halt the running hello world and inspect all CPU registers. See what function it's in (from PC), stack pointer value, arguments in a0-a7. Can modify registers. Cannot see memory, set breakpoints, or single-step.
